...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2025 at 05:39 AM
...
('A001', 'P026', 'T001', 'S2001', 'Comembo Branch', '2025-11-04', '9:00AM-10:00AM', 'secondBatch', 'Confirmed', '2025-11-03 13:49:53'),
('A002', 'P027', 'T001', 'S2001', 'Comembo Branch', '2025-11-09', '10:00AM-11:00AM', 'thirdBatch', 'Pending', '2025-11-06 01:18:40'),
...
('S001', 'General Dentistry', 'Checkups', 'Routine dental checkups involve a comprehensive examination and cleaning to prevent oral disease, while a tooth extraction is the removal of a tooth that is too damaged or infected to be saved.', 5000.00, '2025-11-01 03:44:24'),
('S002', 'Orthodontics', 'Braces', 'To provide a comprehensive overview that captures the essential ideas while leaving out the non-essential details. A good summary is always much shorter than the original.', 30000.00, '2025-11-02 00:37:46'),
('S2001', 'General Dentistry', 'Cleaning', 'A professional dental cleaning is a procedure typically performed by a dental hygienist or dentist to thoroughly clean your teeth and maintain optimal oral health.', 1500.00, '2025-11-02 00:33:50'),
('S3001', 'General Dentistry', 'Tooth Extraction', 'Performed on a tooth that is visible and easily accessible in the mouth. The dentist loosens the tooth with an instrument called an elevator and then removes it with forceps.', 4000.00, '2025-11-02 00:35:18');
